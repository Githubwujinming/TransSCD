...
class SSCDl(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        return F.interpolate(change, x_size[2:], mode='bilinear',align_corners=True), F.interpolate(out1, x_size[2:], mode='bilinear',align_corners=True), F.interpolate(out2, x_size[2:], mode='bilinear',align_corners=True)