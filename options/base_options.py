...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='BiSRN', help='chooses which model to use. [CDF0 | CDFA]')
        ...
        parser.add_argument('--n_class', type=int, default=7, help='# of output pred channels: 2 for num of classes')
