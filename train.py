...
def make_val_opt(opt):
    ...
    val_opt.dataset_mode = opt.dataset_mode
...
def make_fcs_opt(opt):
    ...
    val_opt.dataroot="/data/datasets/SECOND_scd/train"
    val_opt.val_dataroot="/data/datasets/SECOND_scd/test"
    val_opt.test_dataroot="../LEVIR-CD_cropped256/test/"
    val_opt.model='BiSRN'
    val_opt.dataset_mode='second'
    val_opt.batch_size=4
    val_opt.arch='FCSD'
    val_opt.num_threads=4
    val_opt.save_epoch_freq=1
    val_opt.angle=15
    val_opt.preprocess = 'rotate_flip'
    val_opt.gpu_ids=[1]
    val_opt.n_class = 7
    val_opt.display_ncols=4
    return val_opt
